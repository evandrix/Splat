...
class TestProgram(unittest.TestCase):
    def setUp(self):
        ...
        self.module = __import__('algorithms.sorting')
    def tearDown(self):
    ...
    def test_topological_sorting_all_Nones(self): 
        self.assertRaises(AttributeError, self.module.topological_sorting, *[None])
