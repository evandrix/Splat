...
class TestBytecodeTracerGlobalAccessAndRebinding(TestBytecodeTracer):
    ...
    def test_handles_global_variable_reading(self):
        ...
        def fun():
            return return_value
        self.trace_function(fun)
        self.assert_trace(('load_global', ('test_bytecode_tracer', 'return_value', 42)))
    ...
    def test_handles_global_variable_rebinding(self):
        def fun():
            ...
            return_value = 123
        self.trace_function(fun)
        self.assert_trace(('store_global', ('test_bytecode_tracer', 'return_value', 123)))
    ...
    def test_handles_global_variable_unbinding(self):
        def fun():
            ...
            del return_value
        self.trace_function(fun)
        self.assert_trace(('delete_global', ('test_bytecode_tracer', 'return_value')))
