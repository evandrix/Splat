...
class TestProgram(unittest.TestCase):
    def setUp(self):
        ...
        self.module = __import__('DFS_single')
    def tearDown(self):
    ...
    def test_depth_first_search_all_None(self): 
        self.assertNotRaises(self.module.depth_first_search, *[None, None])
        self.assertEqual(self.module.depth_first_search(*[None, None]), True, 'incorrect function return value encountered')

    def test_depth_first_search_all_attr_None_wdef(self): 
        self.assertNotRaises(self.module.depth_first_search, *[None, None])
        self.assertEqual(self.module.depth_first_search(*[None, None]), True, 'incorrect function return value encountered')

    def test_depth_first_search_all_attr_MetaParam_wdef(self): 
        self.assertNotRaises(self.module.depth_first_search, *[None, None])
        self.assertEqual(self.module.depth_first_search(*[None, None]), True, 'incorrect function return value encountered')
