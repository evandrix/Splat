...
class TestProgram(unittest.TestCase):
    def setUp(self):
        ...
        self.module = __import__('algorithms.searching')
    def tearDown(self):
    ...
    def test_depth_first_search_all_Nones(self): 
        self.assertRaises(AttributeError, self.module.depth_first_search, *[None, None, None])

    def test_breadth_first_search_all_Nones(self): 
        self.assertRaises(AttributeError, self.module.breadth_first_search, *[None, None, None])
